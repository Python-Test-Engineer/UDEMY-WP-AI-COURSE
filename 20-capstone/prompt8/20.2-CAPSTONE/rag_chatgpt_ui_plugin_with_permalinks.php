 ...
 * Description: ChatGPT-style AI search assistant with RAG context and clickable citations
 * Version: 1.0.0
 * Author: Your Name
 * Author URI: https://mydigitalagent.co.uk
 * License: GPL v2 or later
 * Text Domain: rag-chatgpt-ui
 */
...
class RAG_ChatGPT_UI_Assistant {
    ...
    public function __construct() {
        ...
        add_action('wp_ajax_rag_chatgpt_query', array($this, 'handle_search_query'));
    }
    ...
    public function render_admin_page() {
        ...
        * {
        ...
        <div class="wrap chatgpt-wrap">
            <div class="chatgpt-container">
                <div class="chatgpt-header">
                    <h1>💬 ChatGPT-Style RAG Search</h1>
                </div>
                
                <div class="chatgpt-messages" id="chatgpt-messages">
                    <div class="empty-state">
                        <h3>Welcome to RAG Search Assistant</h3>
                        <p>Ask me anything about your content, and I'll search through your posts to find the answer.</p>
                    </div>
                </div>
        ...
        jQuery(document).ready(function($) {
            console.log('🚀 ChatGPT UI Plugin Initialized');
            let isLoading = false;
            ...
            function performSearch() {
                ...
                const ajaxData = {
                    action: 'rag_chatgpt_query',
                    nonce: '<?php echo wp_create_nonce('rag_chatgpt_nonce'); ?>',
                    query: query,
                    limit: 5
                };
    ...
    public function handle_search_query() {
        check_ajax_referer('rag_chatgpt_nonce', 'nonce');
        ...
        // Generate answer
        $answer_data = $this->generate_answer($query, $context);
        ...
        $api_response = wp_remote_post('https://api.openai.com/v1/chat/completions', array(
            ...
            'body' => json_encode(array(
                ...
                'messages' => array(
                    array(
                        'role' => 'system',
                        'content' => "You are a helpful assistant that answers questions based on the provided context. If the context doesn't contain enough information to answer the question, respond with 'My RAG does not have the answer.' Be conversational and friendly in your responses."
                    ),
                    array(
                        'role' => 'user',
