...
Create a WordPress Plugin with admin menu level 4.7 that uses these two apis to get the "context" and ensure the agent answers questions on this context first. 

If it cannot answer the query, say "My RAG does not have the answer".