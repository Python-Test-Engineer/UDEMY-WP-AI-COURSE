 ...
 * Description: Manages a custom table for RAG processing of WordPress posts with Full-Text Search
 * Version: 1.3
 * Author: Your Name
 */
    ...
    public function admin_page() {
        ...
        <div class="wrap">
            ...
            <div class="card" style="margin-top: 20px;">
                ...
                <p>Use this endpoint to search posts via natural language:</p>
                <code><?php echo esc_url(rest_url('posts-rag/v1/search')); ?>?query=YOUR_SEARCH_QUERY&limit=3</code>
                <p class="description">Parameters: <strong>query</strong> (required), <strong>limit</strong> (optional, default: 3, max: 20)</p>
            </div>
